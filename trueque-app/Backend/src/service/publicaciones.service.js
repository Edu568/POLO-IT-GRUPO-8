...
const { getAllPublicaciones, 
      ...
      getPublicacionById, 
      deletePublicacion: deletePublicacionModel,
      getAllPublicacionesByUsuario } = require('../models/publicaciones.model');

const { 
    getTransaccionesPendientesByPublicacion, 
    setEstadoTransaccion } = require('../models/transaccion.model');


function listarPublicacionesPorUsuario(id){
  return new Promise((resolve,reject) =>{
    getAllPublicacionesByUsuario(id, (error, publicaciones) =>{
